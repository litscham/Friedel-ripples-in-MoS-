...
\begin{figure}[h!]
    \centering
    \input{friedel_oscillation_decay_plot.tex}
...
\end{figure}
As illustrated in Figure~\ref{fig:friedel_decay}, the electron density modulation decays as $1/r^3$ and the oscillation wavelength varies according to the Fermi wavevector for each metal.
