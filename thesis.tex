...
\input{tex\1literature-review_1-friedel-oscillations.tex}
\label{sec:lit_bulk_friedel}

\input{tex\1literature-review_2-mos2-electronic-stucture.tex}
\label{sec:lit_mos2_structure}

\input{tex\1literature-review_3-defects-2d-materials.tex}
